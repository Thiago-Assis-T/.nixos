{ inputs, pkgs, ... }:
let
  statusnotifier-systray-gtk4 = pkgs.callPackage ./packages/statusnotifier-systray-gtk4.nix {
...
in
{
  nixpkgs.config.packageOverrides = pkgs: {
    ...
    slstatusLaptop = pkgs.slstatus.override { conf = ./configs/slstatusLaptop.h; };
    dwl =
