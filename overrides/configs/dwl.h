...
static const Rule rules[] = {
	...
	{ "pavucontrol",      NULL,       0,            1,          0,      0,         -1 }, /* Start on ONLY tag "9" */
...
static const Key keys[] = {
 ...
 { MODKEY,                    XKB_KEY_p,          spawn,          SHCMD("slurp -d | grim -g - - | wl-copy") },
 { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_P,          spawn,          SHCMD("slurp -d | grim -g - ") },
